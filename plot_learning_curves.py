...
log_path = os.path.join( 'output', 'log' , 'Vanilla-Tacotron2-Blizzard-Challenge' )
fig_name = 'Vanilla-Tacotron2-Blizzard-Challenge.png'
...
if __name__ == '__main__':
    ...
    experiments = {'Vanilla Tacotron2 on LJ-Speech': log_path}
